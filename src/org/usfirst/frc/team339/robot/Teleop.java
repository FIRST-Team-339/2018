...
public static void init ()
{
    ...
    SmartDashboard.putNumber("DStraight Constant", 0);
    SmartDashboard.putNumber("Drive Test Speed", 0);
    SmartDashboard.putNumber("Drive Test Acceleration", 0);
    SmartDashboard.putNumber("Brake Value", 0);
    SmartDashboard.putNumber("Brake Iterations", 0);
    SmartDashboard.putNumber("Brake Deadband", 0);
...
public static void periodic ()
{
    ...
    if (Hardware.demoModeSwitch.isOn() == false)
        // We are in COMPETITION MODE!!!
        Hardware.drive.shiftGears(Hardware.rightDriver.getRawButton(3),
...
private static void testingDrive ()
{
    ...
    // (int) SmartDashboard.getNumber("Brake Deadband", 0),
    // BrakeType.AFTER_DRIVE);
        ...
        SmartDashboard.putBoolean("Has Cube ", false);
            ...
            .getIntakeMotorSpeed() > Hardware.cubeManipulator.INTAKE_STOP_WITH_CUBE
                    + .1 /*
                          ...
                          * making a constant for;
                          * is meant to prevent false positives in cases where
                          * the getIntakeMotorSpeed is
