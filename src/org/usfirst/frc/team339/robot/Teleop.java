...
public class Teleop
{
	...
	public static void init()
	{
		...
		{
			Hardware.transmission.setGearPercentage(0, Hardware.delayPot.get(0, .7));
	...
	public static void periodic()
	{
		...
		if (Hardware.demoModeSwitch.isOn() == false)
		{
			...
			Hardware.cubeManipulator.ejectCube(Hardware.leftOperator.getTrigger(),
		...
		if (Hardware.demoModeSwitch.isOn() == false)
			// We are in COMPETITION MODE!!!
			Hardware.transmission.shiftGears(Hardware.rightDriver.getRawButton(3), Hardware.leftDriver.getRawButton(3));
		else
		{
			// We are in DEMO MODE!!!
			if (Hardware.leftDriver.getRawButton(7) == true)
				...
				Hardware.transmission.setGearPercentage(0, Hardware.delayPot.get(0, .6));
		...
		if (isTestingDrive == false || Hardware.demoModeSwitch.isOn() == false)
	...
	private static void beckyTest()
	{
		...
		if (isBeckyTest == true)
		{
			...
			{
				Hardware.transmission.setForTeleop(Robot.KILROY_XV_GEAR_2_SPEED);
				isBeckyTest = false;
			}
			Hardware.tempRelay.set(true);
			// Hardware.tempRelay.set(true);
