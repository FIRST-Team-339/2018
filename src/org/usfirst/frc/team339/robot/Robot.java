...
public class Robot extends IterativeRobot
{
	...
	public void robotInit()
	{
		...
		{
			Hardware.drive.setEncoderDistancePerPulse(KILROY_XIX_ENCODER_DPP, MotorPosition.ALL);

			Hardware.liftingEncoder.setDistancePerPulse(KILROY_XIX_LIFT_ENCODER_DPP);
			Hardware.intakeDeployEncoder.setDistancePerPulse(KILROY_XIX_DEPLOY_ENCODER_DPP);

			Hardware.drive.setAllGearPercentages(KILROY_XIX_GEAR_1_SPEED, KILROY_XIX_GEAR_2_SPEED);
			...
			// Braking constants
			Hardware.drive.setBrakePower(KILROY_XIX_BRAKE_DRIVE_POWER, BrakeType.AFTER_DRIVE);
			Hardware.drive.setBrakePower(KILROY_XIX_BRAKE_TURN_POWER, BrakeType.AFTER_TURN);

			Hardware.drive.setBrakeDeadband(KILROY_XIX_BRAKE_DRIVE_DEADBAND, BrakeType.AFTER_DRIVE);
			Hardware.drive.setBrakeDeadband(KILROY_XIX_BRAKE_TURN_DEADBAND, BrakeType.AFTER_TURN);
			Hardware.drive.setDriveStraightConstant(KILROY_XIX_DRIVESTRAIGHT_CONSTANT);
		...
		{
			Hardware.drive.setEncoderDistancePerPulse(KILROY_XV_ENCODER_DPP, MotorPosition.ALL);

			Hardware.liftingEncoder.setDistancePerPulse(KILROY_XIX_LIFT_ENCODER_DPP);
			Hardware.intakeDeployEncoder.setDistancePerPulse(KILROY_XIX_DEPLOY_ENCODER_DPP);

			Hardware.drive.setAllGearPercentages(KILROY_XV_GEAR_1_SPEED, KILROY_XV_GEAR_2_SPEED);
		...
		if (Hardware.onNessie == true)
		{
			...
			Hardware.drive.setAllGearPercentages(NESSIE_GEAR_1_SPEED, NESSIE_GEAR_2_SPEED);
		} // if
		else
		// ----------------------------------
		...
		{
			Hardware.cubeManipulator.setMaxLiftHeight(demoForkliftMaxHeight);
		}
		...
		System.out.println("Kilroy XIX is started.  All hardware items created.");
	} // end robotInit()
