...
public class Drive extends DriveBase
{
	...
	private KilroyEncoder leftFrontEncoder = null, rightFrontEncoder = null, leftRearEncoder = null,
	 ...
	 */
	public Drive(TransmissionBase transmission, KilroyEncoder leftFrontEncoder, KilroyEncoder rightFrontEncoder,
			KilroyEncoder leftRearEncoder, KilroyEncoder rightRearEncoder, GyroBase gyro)
	{
		super(transmission, leftRearEncoder, rightRearEncoder, leftFrontEncoder, rightFrontEncoder);
	...
	{
		super(transmission, leftEncoder, rightEncoder);
		this.transmissionType = transmission.getType();
	 ...
	 * 
	 * This works by polling the encoders every (COLLECTION_TIME) milliseconds and
	 * then taking the difference from the last collection and using it as a ratio
	 * to multiply times the speed.
	 * 
