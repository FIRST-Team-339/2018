...
public class Drive
{
	 ...
	 *  {@link #turnDegrees(int, double, boolean) turnDegrees(degrees, speed, usingGyro)}
	 * 
	 * @param angle
	 ...
	 * 
	 * @param degrees How far the robot should turn. Positive for clockwise, negative for counter-clockwise
	 * @param speed How fast the robot should turn, from 0.0 to 1.0.
	 * @param acceleration How much time, in seconds, the motors should accelerate to speed over.
	 * @param usingGyro If true, the gyro will be the chosen sensor. If false, the encoders will be used.
	 * @return Whether or not the robot has finished turning the requested number of degrees, used in a state machine.
	 */
