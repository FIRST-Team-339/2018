...
public void driveStraight (double speed, double acceleration)
{
    if (System.currentTimeMillis()
        ...
        this.driveStraightPID.getPIDController().setPID(
    ...
    super.accelerateTo(speed + driveStraightPIDOutput,
            speed - driveStraightPIDOutput, acceleration);
 ...
 */
private void setAllPIDSourceTypes (PIDType sourceType)
{
    for (KilroyPID pid : encoderPID)
        pid.setSensorType(sourceType);
    for (KilroyPID pid : gyroPID)
        pid.setSensorType(sourceType);
    ...
    switch (type)
        ...
        case TURN_GYRO:
            if (tuneTurnDegreesGyroPIDInit == true)
                {
                SmartDashboard.putNumber("Turn Gyro P",
                        turnGyroPIDTolerance[0]);
                SmartDashboard.putNumber("Turn Gyro I",
                        turnGyroPIDTolerance[1]);
                SmartDashboard.putNumber("Turn Gyro D",
                        turnGyroPIDTolerance[2]);
                SmartDashboard.putNumber("Turn Gyro Tolerance",
                        turnGyroPIDTolerance[3]);
                tuneTurnDegreesGyroPIDInit = false;
                }

            this.turnGyroPIDTolerance[0] = SmartDashboard
                    .getNumber("Turn Gyro P", turnGyroPIDTolerance[0]);
            this.turnGyroPIDTolerance[1] = SmartDashboard
                    .getNumber("Turn Gyro I", turnGyroPIDTolerance[1]);
            this.turnGyroPIDTolerance[2] = SmartDashboard
                    .getNumber("Turn Gyro D", turnGyroPIDTolerance[2]);
            this.turnGyroPIDTolerance[3] = SmartDashboard.getNumber(
                    "Turn Gyro Tolerance", turnGyroPIDTolerance[3]);
            return;
        ...
        case DRIVESTRAIGHT_GYRO:
            if (tuneDriveStraightGyroInit == true)
                {
                SmartDashboard.putNumber("Drive Straight Gyro P",
                        driveStraightGyroPIDTolerance[0]);
                SmartDashboard.putNumber("Drive Straight Gyro I",
                        driveStraightGyroPIDTolerance[1]);
                SmartDashboard.putNumber("Drive Straight Gyro D",
                        driveStraightGyroPIDTolerance[2]);
                SmartDashboard.putNumber(
                        "Drive Straight Gyro Tolerance",
                        driveStraightGyroPIDTolerance[3]);
                tuneDriveStraightGyroInit = false;
                }

            this.driveStraightGyroPIDTolerance[0] = SmartDashboard
                    .getNumber("Drive Straight Gyro P",
                            driveStraightPIDTolerance[0]);
            this.driveStraightGyroPIDTolerance[1] = SmartDashboard
                    .getNumber("Drive Straight Gyro I",
                            driveStraightPIDTolerance[1]);
            this.driveStraightGyroPIDTolerance[2] = SmartDashboard
                    .getNumber("Drive Straight Gyro D",
                            driveStraightPIDTolerance[2]);
            this.driveStraightGyroPIDTolerance[3] = SmartDashboard
                    .getNumber("Drive Straight Gyro Tolerance",
                            driveStraightPIDTolerance[3]);
            return;
        default:
            return;
