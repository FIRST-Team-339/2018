...
public class Hardware
{
	...
	// Momentary Switches
	// ------------------------------------
	public static MomentarySwitch visionTestButton = new MomentarySwitch(leftOperator, 2,
			false /* starting state */);

	public static MomentarySwitch climbButton = new MomentarySwitch(rightOperator, 10,
			false /* starting state */);
	...
	// Transmission class
	// ------------------------------------
	public static TankTransmission transmission = new TankTransmission(new SpeedControllerGroup(leftDriveMotor),
			new SpeedControllerGroup(rightDriveMotor));
